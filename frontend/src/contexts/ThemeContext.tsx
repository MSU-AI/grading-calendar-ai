...
export interface Theme {
  ...
  cards: {
    ...
    glassHover: React.CSSProperties;
    glassAccent: React.CSSProperties;
    glassDark: React.CSSProperties;
  };
  forms: {
...
export const ThemeProvider: React.FC<{children: ReactNode}> = ({ children }) => {
  ...
  // Initialize global styles when theme changes
  useEffect(() => {
    // Add CSS for animations
    const styleTag = document.createElement('style');
    styleTag.innerHTML = theme.animations;
